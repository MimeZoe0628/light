...
namespace LightGBM {
/*!
* \brief Used to store and update score for data 用来存储、更新数据的分数
*/
class ScoreUpdater {
public:
  /*!
  * \brief Constructor, will pass a const pointer of dataset 构造器，传递数据集的常量指针
  * \param data This class will bind with this data set	该类与数据集绑定
  */
  ScoreUpdater(const Dataset* data, int num_tree_per_iteration) : data_(data) {
    ...
    // default start score is zero	默认初始分数为0
